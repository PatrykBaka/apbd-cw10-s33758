        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abbrevation = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Abbrevation", "FoundationDate", "FullName" },
                values: new object[,]
                {
                    { 1, "M1", new DateOnly(2000, 1, 1), "Manufacturer 1" },
                    { 2, "M2", new DateOnly(2010, 5, 10), "Manufacturer 2" },
                    { 3, "M3", new DateOnly(2015, 12, 20), "Manufacturer 3" }
                });

            migrationBuilder.InsertData(
                table: "ComponentTypes",
                columns: new[] { "Id", "Abbrevation", "Name" },
                values: new object[,]
                {
                    { 1, "T1", "Type 1" },
                    { 2, "T2", "Type 2" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 5, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "PC 1", 5, 12, 12f },
                    { 2, new DateTime(2026, 5, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "PC 2", 7, 24, 20f },
                    { 3, new DateTime(2026, 5, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "PC 3", 4, 12, 15f }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "C1", 1, 1, "Desc 1", "Comp 1" },
                    { "C2", 2, 2, "Desc 2", "Comp 2" },
                    { "C3", 3, 3, "Desc 3", "Comp 3" }
                });
